...
import { HeroCTA } from '@/components/motion/HeroCTA';
          ...
          <HeroRevealContainer>
            ...
            <HeroRevealLine>
              <p className="mt-[30px] max-w-[520px] text-[18px] leading-[1.55] text-ink-70">
                17-year-old developer from Poland. Three years shipping across
                the full stack - React &amp; Next.js on the front, Node &amp;
                Postgres behind it, automation and security woven through.
              </p>
            </HeroRevealLine>
            <HeroRevealLine>
