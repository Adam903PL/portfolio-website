...
const footerLinks: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      {
        title: 'Lublin, Poland',
        href: 'https://share.google/2wsH0hlMaxFJFtw2R',
      },
...
const Footer = () => {
  ...
  return (
    <footer className="md:rounded-t-6xl relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-4xl border-t border-white/10 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] px-6 py-12 lg:py-16">
      ...
      <div
        aria-hidden
        className="absolute inset-0 -z-10 overflow-hidden rounded-t-4xl md:rounded-t-6xl"
      >
        <div className="absolute bottom-0 right-0 size-96 bg-gradient-to-tl from-gray-800/20 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute top-0 left-0 size-96 bg-gradient-to-br from-gray-700/10 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-12">
        ...
        <AnimatedContainer className="space-y-6">
          <div>
            <h3 className="text-3xl font-bold mb-3 text-white">Adam Pukaluk</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              16-year-old developer passionate about creating exceptional
              digital experiences. Student at TechniSchools Lublin, specializing
                  ...
                  {section.links.map((link) => (
                    <li key={link.title}>
                      <a
                        ...
                        className="text-gray-400 hover:text-white inline-flex items-center gap-1 transition-colors duration-300 text-sm group"
                      >
